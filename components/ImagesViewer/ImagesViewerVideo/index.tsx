...
export const ImagesViewerYoutubeVideo: React.FC<ImagesViewerYoutubeVideoProps> = ({
	...
	const [loadingStatus, setLoadingStatus] = React.useState<'never' | 'loading' | 'loaded'>('never');
	...
	return (
		<>
			...
			{isLoading && <CircularProgress className={classes.loader} size={40} color="primary" />}
		</>
	);
};
