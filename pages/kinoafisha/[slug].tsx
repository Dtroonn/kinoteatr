...
const KinoafishaPage: React.FC<KinoafishaPageProps> = ({ films, category }) => {
	console.log('KINOAFISHA');
	return (
...
export const getServerSideProps: GetServerSideProps<KinoafishaPageProps> = async ({
	params,
	query,
}) => {
